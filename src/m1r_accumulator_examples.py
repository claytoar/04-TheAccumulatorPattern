...
#            for k in range(r + 1):
#
#           I would choose the 2nd option - for k in range(r):
#
...
#                  return count
#
#           1. range should be ((s + 1) - r), not (r - s)
#           2. initializing the count to 0 should be outside the loop
#           3. variable inside math.cos should be k, not r
#           4. the indented count should be set to count + 1 under the if statement
#           5. return count should be out of the loop (not indented)
#
#     f. The code in the "graphics accumulation" example below includes:
#            for _ in range(n):
#        What does the   _   (underscore) mean?
#
#           The loop does not use its index variable
#
